 ...
 * @Date: 2026-01-18 23:11:27
 * @LastEditors: laladuduqq 2807523947@qq.com
 * @LastEditTime: 2026-01-19 10:13:26
 * @FilePath: /MAS_RM_DJIC/Mas_User/MODULES/RGB/module_rgb.c
 * @Description:
 */
...
void Module_Rgb_init(void)
{
    PWM_Init_Config config = {
        .channel = TIM_CHANNEL_3, .dutyx10 = 0, .htim = &htim5, .Mode = PWM_MODE_BLOCKING};
